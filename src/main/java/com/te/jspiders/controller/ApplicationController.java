...
public class ApplicationController {
    ...
    public ApiResponse<String> registerTrainer(@RequestBody TrainerDTO trainerDto) {
        ...
        if (trainerId.isPresent()) {
            return new ApiResponse<String>("Trainer registration successful!", null, trainerId.get());
        }
    ...
    public ApiResponse<String> registerStudent(@RequestBody StudentDTO studentDto) {
        ...
        if (stuId.isPresent()) {
            return new ApiResponse<String>("Student registration successful!", null, stuId.get());
        }
    ...
    public ApiResponse<String> registerEmployee(@RequestBody EmployeeDTO employeeDto) {
        ...
        if (empId.isPresent()) {
            return new ApiResponse<String>("Employee registration successful!", null, empId.get());
        }
    ...
    public ApiResponse<Object> login(@RequestBody LoginDTO loginDto) {
        ...
        return new ApiResponse<Object>("Login successful!", token, null);
    }
}